...
def prune_min(t):
    ...
    if t.is_leaf():
        ...
        label_to_keep = min([b.label for b in t.branches])
        for b in t.branches:
            if b.label == label_to_keep:
                t.branches = [b]
                return prune_min(b)
...
def foldl2(link, fn, z):
    ...
    def step(x, g):
        ...
        if g == identity:
            g = z
        return fn(g, x)
    return foldr(link, step, identity)
